...
class="arrows">&#8681;</span></td><td></td></tr>
 ...
 <tr><td align="left"><b>Speed:</b></td><td colspan=2><input
type="range" min="0" max="255" value="150" class="slider" id="Speed"
oninput='sendButtonInput("Speed",value)'></td></tr>
 <tr><td align="left"><b>Tilt:</b></td><td colspan=2><input
type="range" min="0" max="180" value="90" class="slider" id="Tilt"
oninput='sendButtonInput("Tilt",value)'></td></tr>
 <tr><td><b>Pan:</b></td><td colspan=2><input type="range" min="0"
max="180" value="90" class="slider" id="Pan"
oninput='sendButtonInput("Pan",value)'></td></tr>
 </table>
 <script>
 var websocketCarInput;
 function initWebSocket() {
 websocketCarInput = new WebSocket("ws://" + window.location.hostname +
"/CarInput");
...
void moveCar(int inputValue) {
 switch (inputValue) {
 case UP: rotateMotor(RIGHT_MOTOR, BACKWARD); rotateMotor(LEFT_MOTOR,
BACKWARD); break;
 case DOWN: rotateMotor(RIGHT_MOTOR, FORWARD); rotateMotor(LEFT_MOTOR,
FORWARD); break;
 case LEFT: rotateMotor(RIGHT_MOTOR, BACKWARD); rotateMotor(LEFT_MOTOR,
FORWARD); break;
 case RIGHT: rotateMotor(RIGHT_MOTOR, FORWARD); rotateMotor(LEFT_MOTOR,
BACKWARD); break;
 default: rotateMotor(RIGHT_MOTOR, STOP); rotateMotor(LEFT_MOTOR, STOP);
break;
 }
}
void setUpPinModes() {
...
void onCarInputWebSocketEvent(AsyncWebSocket *server, AsyncWebSocketClient
